...
public class CustomerInteraction {
	...
	public static LinkedList<OrderClass> Orders = new LinkedList<OrderClass>();
				...
				case "4":
					...
					for(OrderClass order : Orders) {
						...
						System.out.println("Cart: ");
							...
							for (String CartItem : order.cart) {
							...
							System.out.println("Authorization Number: " + order.authorize);
